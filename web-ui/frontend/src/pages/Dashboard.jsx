...
export default function Dashboard() {
    ...
    const filteredCases = React.useMemo(() => {
        ...
        return cases.filter(c => 
            `${c.fname} ${c.lname}`.toLowerCase().includes(lowQuery) ||
            String(c.case_id || c.id).toLowerCase().includes(lowQuery)
        );
    }, [cases, searchQuery]);
                        ...
                        {filteredCases.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="6" style={{ textAlign: 'center', padding: '2rem' }}>
                                    {searchQuery ? "No matching records found." : "No cases found. Create a new case to get started."}
                                </td>
                            </tr>
                        )}
                    </tbody>
